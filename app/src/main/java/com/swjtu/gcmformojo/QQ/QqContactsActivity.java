...
import com.swjtu.gcmformojo.Util.NetUtil;
...
public class QqContactsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExpandableListView qqFriendExpandListView = findViewById(R.id.qq_friend_ExpandListView);
        FloatingActionButton qqContactsUpdateButton = findViewById(R.id.qq_contacts_update);
